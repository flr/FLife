...
protected: 
  ...
  // estimation
  inline double NewRhap(double func, double grad) {return(func/grad);}
...
FLQuant     fCPP(FLQuant, FLQuant,double,int);
FLQuant stockCPP(FLQuant, FLQuant,double,int);
#endif /* _INC_logistic */

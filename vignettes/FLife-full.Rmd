...
[FLR](http://www.flrproject.org) website, where  [tutorials](https://www.flrproject.org/doc/) are also available.
...
install.packages("FLife", repos = "http://flrproject.org/R", INSTALL_opts="-no_multiarch" )
```

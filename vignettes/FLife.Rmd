...
```{r, pkgs2, echo=FALSE, message=FALSE}
library(reshape)
library(plyr)
```
...
```{r, pkgs3, echo=FALSE, message=FALSE}
library(FLCore)
library(ggplotFL)
...
```{r, pkgs4, echo=FALSE, message=FALSE}
library(popbio)
```
...
```{r fig13, fig.width=10,fig.height=4,fig.cap="Cohort Effects"}
